...
<script>
    ...
    function ViewModel() {
        ...
        me.items = [
            ...
            new MenuItem('Oś czasu Szyszka', 'src/CatFeeding/Views/Reports/timeline.php?CatId=1'),
            new MenuItem('Leki Szyszki', 'src/CatFeeding/Views/medicine.php?Id=1'),
            new MenuItem('Mgiełka', 'src/CatFeeding/Views/cat.php?Id=2'),
            new MenuItem('Pokarm Mgiełka', 'src/CatFeeding/Views/food.php?Id=2'),
            new MenuItem('Oś czasu Mgiełka', 'src/CatFeeding/Views/Reports/timeline.php?CatId=2'),
            ...
            new Shortcut('🎁 Prezenty', 'src/Knowledge/Views/item.php?Id=93'),
        ...
        me.matchingItems = ko.computed(function () {
            const matchingItems = me.items.filter(item =>
                me.showShortcuts && item.isShortcut
                || me.query() != null && item.text.toLowerCase().includes(me.query().toLowerCase()));
